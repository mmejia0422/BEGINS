...
public class CatProducto  implements java.io.Serializable {
    ...
    public CatProducto() {
        ...
        this.tipoCategoria = new TipoCategoria();
        this.idCatProducto = 0;
    }

	
    public CatProducto(Categoria categoria, Marca marca, Presentacion presentacion, TipoCategoria tipoCategoria) {
        this.categoria = categoria;
        this.marca = marca;
        this.presentacion = presentacion;
        this.tipoCategoria = tipoCategoria;
    }
    public CatProducto(Categoria categoria, Marca marca, Presentacion presentacion, TipoCategoria tipoCategoria, String nombre, String descripcion, Byte precio, Set productoProveedors, Set productos, Set detaOrdenCompras, Set detaOrdenVentas) {
       this.categoria = categoria;
       this.marca = marca;
       this.presentacion = presentacion;
       this.tipoCategoria = tipoCategoria;
